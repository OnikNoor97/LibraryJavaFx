...
public class LibraryMainController extends Feature implements Initializable {
    
    //Example of inheritance and polymorphism
    //this Class in Child/Subclass (inherits from feature class using extends method)
    ...
    {
        ArrayList<Item> itemsForLibrary = loadItemsForLibrary();
    ...
    {
        ArrayList<Item> itemsForUser = loadItemsFromUser(userLoggedIn);
    ...
    public void addBalanceAction(ActionEvent event) throws IOException, NumberFormatException
    {
        ...
        addBalance(userLoggedIn, input);
        
        alert("Information", "Balance has been added!");
