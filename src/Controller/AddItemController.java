...
public class AddItemController extends Feature implements Initializable {
    ...
    public void confirmAction(ActionEvent event) throws IOException
    {
        try
        {
            ...
            {
                alert("Error", "Input all information required");
            }
            else
            {
                ...
                writer.close();
                alert("Information", "Item has been created");
        ...
        {
            alert("Error", "Please pick a type");
        }
    }
